// .wrangler/tmp/bundle-gc2AsW/checked-fetch.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/utils/body.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/utils/url.js
var splitPath = (path) => {
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/request.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/utils/html.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/context.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/compose.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/router.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/hono-base.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/router/reg-exp-router/node.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/router/reg-exp-router/trie.js
var Trie = class {
  context = { varIndex: 0 };
  root = new Node();
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/router/reg-exp-router/router.js
var emptyParam = [];
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/router/smart-router/router.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/router/trie-router/node.js
var Node2 = class {
  methods;
  children;
  patterns;
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/router/trie-router/router.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/hono.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/middleware/cors/index.js
var cors = (options) => {
  const defaults = {
    origin: "*",
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/utils/cookie.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/helper/cookie/index.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/http-exception.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/utils/encode.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/utils/jwt/jwa.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/helper/adapter/index.js
var knownUserAgents = {
  deno: "Deno",
  bun: "Bun",
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/utils/jwt/types.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/utils/jwt/utf8.js
var utf8Encoder = new TextEncoder();
var utf8Decoder = new TextDecoder();

// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/utils/jwt/jws.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/utils/jwt/jwt.js
...
// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/utils/jwt/index.js
var Jwt = { sign, verify, decode };

// node_modules/.pnpm/hono@4.5.5/node_modules/hono/dist/middleware/jwt/jwt.js
var jwt = (options) => {
...
app.post("/login", async (c) => {
  ...
  const token = await sign2({ id: result.id }, jwtSecret);
...
app2.patch("/:id/password", async (c) => {
  const db = c.env.DB;
  const id = c.req.param("id");
...
app2.patch("/:id/birthdate", async (c) => {
  const db = c.env.DB;
  const id = c.req.param("id");
  const { birthdate } = await c.req.json();
...
app3.post("/", async (c) => {
  ...
  const booking_activity_id = (await db.prepare("select last_insert_rowid() as id").first()).id;
...
app3.patch("/:id/update-time-and-doctor", async (c) => {
  const db = c.env.DB;
  const id = c.req.param("id");
  const {
    starts_at,
...
var bookingActivities_default = app3;

// src/utils/base64Util.ts
...
app4.post("/:id/deactivate", async (c) => {
  const db = c.env.DB;
  const id = c.req.param("id");
...
app4.post("/", async (c) => {
  ...
  const doctorId = (await db.prepare("select last_insert_rowid() as id").first()).id;
...
app6.route("/patients", patients_default);
app6.route("/doctors", doctors_default);
app6.route("/booking-activities", bookingActivities_default);
app6.route("/poli", poli_default);
var src_default = app6;

// node_modules/.pnpm/wrangler@3.71.0_@cloudflare+workers-types@4.20240806.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// node_modules/.pnpm/wrangler@3.71.0_@cloudflare+workers-types@4.20240806.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-gc2AsW/middleware-insertion-facade.js
...
// node_modules/.pnpm/wrangler@3.71.0_@cloudflare+workers-types@4.20240806.0/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-gc2AsW/middleware-loader.entry.ts
